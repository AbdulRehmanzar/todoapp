...
class Todos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Daily Shedule')),
      body: Column(
        children: [
          Row(
            children: [
...
class TodoCard extends StatelessWidget {
  ...
  void editTodo(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) => AlertDialog(
        title: const Text('Edit Shedule Text'),
  ...
  @override
  Widget build(BuildContext context) {
    final hexCode = int.parse('0xff${todo.id.substring(0, 8)}');
    return Container(
      color: Color(hexCode).withOpacity(0.075),
